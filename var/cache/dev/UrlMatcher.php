...
return [
    ...
    [ // $regexpList
        0 => '{^(?'
                ...
                .'|/post/(?'
                    ...
                    .'|commentaire/([^/]++)(*:1136)'
                    .'|stats(*:1150)'
                    .'|p/updatePostMobile/([^/]+)\\?titre\\=([^/]+)&auteur\\=([^/]+)&imgPost\\=([^/]+)&image\\=([^/]++)(*:1250)'
                    .'|deletePostMobile/([^/]++)(*:1284)'
                .')'
                .'|/reclamation/(?'
                    .'|(\\d+)(*:1315)'
                    .'|(\\d+)/edit(*:1334)'
                    .'|(\\d+)(*:1348)'
                    .'|deleteRecMobile/([^/]++)(*:1381)'
                .')'
                .'|/visitor/([^/]++)(?'
                    .'|(*:1411)'
                    .'|/edit(*:1425)'
    ...
    [ // $dynamicRoutes
        ...
        1250 => [[['_route' => 'updatePostMobile', '_controller' => 'App\\Controller\\PostController::updatePostMobile'], ['idPost', 'titre', 'auteur', 'img_post', 'image'], null, null, false, true, null]],
        1284 => [[['_route' => 'deletePostMobile', '_controller' => 'App\\Controller\\PostController::deletePostMobile'], ['idPost'], null, null, false, true, null]],
        1315 => [[['_route' => 'app_reclamation_show', '_controller' => 'App\\Controller\\ReclamationController::show'], ['idRec'], ['GET' => 0], null, false, true, null]],
        1334 => [[['_route' => 'app_reclamation_edit', '_controller' => 'App\\Controller\\ReclamationController::edit'], ['idRec'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        1348 => [[['_route' => 'app_reclamation_delete', '_controller' => 'App\\Controller\\ReclamationController::delete'], ['idRec'], ['POST' => 0], null, false, true, null]],
        1381 => [[['_route' => 'deleteRecMobile', '_controller' => 'App\\Controller\\ReclamationController::deletePostMobile'], ['idRec'], null, null, false, true, null]],
        1411 => [[['_route' => 'app_visitor_show', '_controller' => 'App\\Controller\\VisitorController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        1425 => [[['_route' => 'app_visitor_edit', '_controller' => 'App\\Controller\\VisitorController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        1434 => [[['_route' => 'app_visitor_delete', '_controller' => 'App\\Controller\\VisitorController::delete'], ['id'], ['POST' => 0], null, false, true, null]],
        1477 => [[['_route' => 'wishlistshare', '_controller' => 'App\\Controller\\WishListController::wishlistShare'], ['code'], ['GET' => 0, 'HEAD' => 1], null, false, true, null]],
        1494 => [[['_route' => 'wishlistjoin', '_controller' => 'App\\Controller\\WishListController::wishlistJoin'], ['code'], ['GET' => 0, 'HEAD' => 1], null, false, false, null]],
        1507 => [[['_route' => 'wishlistviewcode', '_controller' => 'App\\Controller\\WishListController::wishlistviewcode'], ['code'], ['GET' => 0, 'HEAD' => 1], null, false, false, null]],
        1531 => [[['_route' => 'wishlistedit', '_controller' => 'App\\Controller\\WishListController::wishlistedit'], ['id'], ['GET' => 0, 'HEAD' => 1], null, false, true, null]],
        1555 => [[['_route' => 'wishlistdelete', '_controller' => 'App\\Controller\\WishListController::wishlistDelete'], ['id'], ['GET' => 0, 'HEAD' => 1], null, false, true, null]],
        1577 => [[['_route' => 'wishlistopen', '_controller' => 'App\\Controller\\WishListController::wishlistOpen'], ['id'], ['GET' => 0, 'HEAD' => 1], null, false, true, null]],
        1609 => [[['_route' => 'wishlistotheropen', '_controller' => 'App\\Controller\\WishListOtherController::wishlistOtherOpen'], ['id'], ['GET' => 0, 'HEAD' => 1], null, false, true, null]],
        1631 => [[['_route' => 'wishlistotherjoin', '_controller' => 'App\\Controller\\WishListOtherController::wishlistOtherJoin'], ['id'], ['GET' => 0, 'HEAD' => 1], null, false, true, null]],
        1654 => [
