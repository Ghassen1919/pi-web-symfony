...
\t\t\t\t\t\t</div>";
        ...
        echo "
\t\t\t\t\t\t<br>
\t\t\t\t\t\t<button class=\"btn\" style=\"background-color:black;border-color: black; color: red\"><a href=";
        // line 108
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("index.php/post/front"), "html", null, true);
...
\t\t\t\t\t\t<br>
\t\t\t\t\t\t<button class=\"btn\" style=\"background-color:black;border-color: black; color: red\"><a href={{asset(\"index.php/post/front\")}}>back to Posts</a></button>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t\t
\t\t\t\t\t\t\t
