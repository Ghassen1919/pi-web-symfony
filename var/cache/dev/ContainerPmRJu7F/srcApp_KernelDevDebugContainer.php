...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getMessageControllerService()
    {
        ...
        return $this->services['App\\Controller\\MessageController'] = new \App\Controller\MessageController(($this->privates['App\\Repository\\MessageRepository'] ?? $this->getMessageRepositoryService()), ($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['security.helper'] ?? $this->getSecurity_HelperService()));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderc1cdf = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5e7d4 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties16b16 = [
        
    ];

    public function getConnection()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'getConnection', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'getMetadataFactory', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'getExpressionBuilder', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'beginTransaction', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'getCache', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->getCache();
    }

    public function transactional($func)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'transactional', array('func' => $func), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'wrapInTransaction', array('func' => $func), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'commit', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->commit();
    }

    public function rollback()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'rollback', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'getClassMetadata', array('className' => $className), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'createQuery', array('dql' => $dql), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'createNamedQuery', array('name' => $name), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'createQueryBuilder', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'flush', array('entity' => $entity), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'clear', array('entityName' => $entityName), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->clear($entityName);
    }

    public function close()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'close', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->close();
    }

    public function persist($entity)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'persist', array('entity' => $entity), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'remove', array('entity' => $entity), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'refresh', array('entity' => $entity), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'detach', array('entity' => $entity), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'merge', array('entity' => $entity), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'contains', array('entity' => $entity), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'getEventManager', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'getConfiguration', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'isOpen', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'getUnitOfWork', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'getProxyFactory', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'initializeObject', array('obj' => $obj), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'getFilters', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'isFiltersStateClean', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'hasFilters', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return $this->valueHolderc1cdf->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer5e7d4 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderc1cdf) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderc1cdf = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderc1cdf->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, '__get', ['name' => $name], $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        if (isset(self::$publicProperties16b16[$name])) {
            return $this->valueHolderc1cdf->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderc1cdf;
    ...
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;
    ...
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, '__isset', array('name' => $name), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;
    ...
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, '__unset', array('name' => $name), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;
    ...
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, '__clone', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        $this->valueHolderc1cdf = clone $this->valueHolderc1cdf;
    }

    public function __sleep()
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, '__sleep', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        return array('valueHolderc1cdf');
    }
    ...
    {
        $this->initializer5e7d4 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer5e7d4;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'initializeProxy', array(), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderc1cdf;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderc1cdf;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer5e7d4 && ($this->initializer5e7d4->__invoke($valueHolderc1cdf, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer5e7d4) || 1) && $this->valueHolderc1cdf = $valueHolderc1cdf;

        if ($this->valueHolderc1cdf === $returnValue = $this->valueHolderc1cdf->paginate($target, $page, $limit, $options)) {
            return $this;
        }
