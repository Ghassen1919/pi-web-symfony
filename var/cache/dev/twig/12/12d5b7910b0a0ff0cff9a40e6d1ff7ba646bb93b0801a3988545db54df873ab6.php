...
\t\t\t\t
\t\t\t\t<div class=\"sucess\">
\t\t\t\t\t<h4>number reclamation total</h4>
\t\t\t\t\t<p>
\t\t\t\t\t\t<h4>";
        // line 13
...
\t\t\t
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["reclamations"]) || array_key_exists("reclamations", $context) ? $context["reclamations"] : (function () { throw new RuntimeError('Variable "reclamations" does not exist.', 31, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["reclamation"]) {
            ...
            echo "            <tr>
                ...
                <td>";
            // line 34
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reclamation"], "nomRec", [], "any", false, false, false, 34), "html", null, true);
            echo "</td>
                <td>";
            // line 35
            ((twig_get_attribute($this->env, $this->source, $context["reclamation"], "dateRec", [], "any", false, false, false, 35)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reclamation"], "dateRec", [], "any", false, false, false, 35), "Y-m-d"), "html", null, true))) : (print ("")));
            echo "</td>
                <td>";
            // line 36
            echo twig_get_attribute($this->env, $this->source, $context["reclamation"], "descriRec", [], "any", false, false, false, 36);
            echo "</td>
                <td>";
            // line 37
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reclamation"], "traite", [], "any", false, false, false, 37), "html", null, true);
            echo "</td>
                <td>
                    <button class=\"btn\" style=\"background-color:black;border-color: white; color: white\">  <a href=\"";
            // line 39
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reclamation_show", ["idRec" => twig_get_attribute($this->env, $this->source, $context["reclamation"], "idRec", [], "any", false, false, false, 39)]), "html", null, true);
            echo "\">show</a></button>
                 <button class=\"btn\" style=\"background-color:#C0392B ;border-color: black;color: purple\">   <a href=\"";
            // line 40
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reclamation_edit", ["idRec" => twig_get_attribute($this->env, $this->source, $context["reclamation"], "idRec", [], "any", false, false, false, 40)]), "html", null, true);
            echo "\">edit</a></button>
                </td>
            </tr>
        ";
...
";
    ...
    {
        return array (  171 => 51,  166 => 48,  157 => 44,  148 => 40,  144 => 39,  139 => 37,  135 => 36,  131 => 35,  127 => 34,  123 => 32,  118 => 31,  97 => 13,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
    ...
    <table class=\"table\">
        ...
        {% for reclamation in reclamations %}
            <tr>
                ...
                <td>
                    <button class=\"btn\" style=\"background-color:black;border-color: white; color: white\">  <a href=\"{{ path('app_reclamation_show', {'idRec': reclamation.idRec}) }}\">show</a></button>
