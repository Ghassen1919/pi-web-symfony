...
\t\t\t\t\t</td> 
    ...
    <button class=\"btn\" style=\"background-color:black;border-color: black;color: purple\"> <a href=\"";
        // line 74
...
\t\t\t\t\t\t\t   \$('#t tbody#search').append(\" <td>\"+obj.rate+\"</td>\"); 
                               \$('#t tbody#search').append(\" <td>\"+\"affiché\"+\"</td>\"); 
...
";
    ...
    {
        return array (  289 => 5,  279 => 4,  212 => 85,  198 => 74,  192 => 71,  184 => 65,  175 => 61,  168 => 58,  162 => 56,  155 => 55,  150 => 53,  145 => 51,  138 => 48,  133 => 47,  128 => 45,  123 => 43,  119 => 42,  115 => 41,  111 => 40,  107 => 39,  103 => 37,  98 => 36,  74 => 14,  72 => 4,  69 => 3,  59 => 2,  36 => 1,);
    }
...
\t\t\t\t\t</td> 
    ...
    <button class=\"btn\" style=\"background-color:black;border-color: black;color: purple\"> <a href=\"{{ path('app_post_new') }}\">Create new</a></button>
    <script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js\">
    </script>
    <script>
        \$( document ).ready(function() {
